...
enum LocalFoodKnowledge {
    static let profiles: [String: FoodProfile] = [
        ...
        "eggs": FoodProfile(canonicalName: "eggs", aliases: ["egg"], category: .protein, section: .fridge, shelfLifeDays: 35, defaultUnit: "count", defaultQuantity: 12, nutrition: NutritionFacts(calories: 72, protein: 6.3, carbs: 0.4, fat: 4.8, fiber: 0), perishable: true),
        "yogurt": FoodProfile(canonicalName: "yogurt", aliases: ["greek yogurt"], category: .dairy, section: .fridge, shelfLifeDays: 14, defaultUnit: "container", defaultQuantity: 1, nutrition: NutritionFacts(calories: 120, protein: 12, carbs: 9, fat: 4, fiber: 0), perishable: true),
        ...
        "bread": FoodProfile(canonicalName: "bread", aliases: ["sliced bread", "loaf"], category: .grain, section: .shelf, shelfLifeDays: 5, defaultUnit: "loaf", defaultQuantity: 1, nutrition: NutritionFacts(calories: 80, protein: 3, carbs: 15, fat: 1, fiber: 1), perishable: true),
        ...
        "chips": FoodProfile(canonicalName: "chips", aliases: ["potato chips", "snack"], category: .treat, section: .shelf, shelfLifeDays: 60, defaultUnit: "bag", defaultQuantity: 1, nutrition: NutritionFacts(calories: 150, protein: 2, carbs: 15, fat: 10, fiber: 1), perishable: false)
    ]
